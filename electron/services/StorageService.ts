...
export class StorageService {
     ...
     */
    async createSession(startTime: number, lengthMs: number, focusGoal: string = ''): Promise<string> {
        return await sessionStorage.createSession(startTime, lengthMs, focusGoal);
    }
